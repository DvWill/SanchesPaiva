...
for(const file of ['index.html','blog.html','post.html','privacidade.html','styles.css','blog.css','blog-fixes.css','post.css','employment-post.css','religious-post.css','admin.css','script.js','citizen.js','citizen-admin.js','home-news.js','data.js','supabase.js','editorial-posts.js','blog.js','post.js','admin.js'])fs.copyFileSync(path.join(root,file),path.join(dist,file));
